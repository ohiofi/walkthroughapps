...
const scriptURL =
  "https://script.google.com/macros/s/AKfycbxGdAEZLEWWWVolS4n0GUfw1s8yR1Ph43ze9KbcAaRHMTO9iM9hT88mgAj1khCIjrLz/exec";
...
const ORS_INPUT = document.getElementById("Opportunities-Resources-Support-input");
const MIN_INPUT = document.getElementById("Meet-Individual-Needs-input");
const TF_INPUT = document.getElementById("Timely-Feedback-input");
const PII_INPUT = document.getElementById("Personalized-Instruction-Intervention-input");
const EO_INPUT = document.getElementById("Engaging-Opportunities-input");
const ECE_INPUT = document.getElementById("Embrace-Culture-Experience-input");
...
function getEmailBody() {
  ...
  result +=
    ...
    ".%0D%0A%0D%0A";
  if (CT_INPUT.value != "") {
    result += "PoL " + "Critical Thinkers: ".toUpperCase() + CT_INPUT.value + "%0D%0A%0D%0A";
  }
  if (EC_INPUT.value != "") {
    result += "PoL " + "Empathetic Citizens: ".toUpperCase() + EC_INPUT.value + "%0D%0A%0D%0A";
  }
  if (PC_INPUT.value != "") {
    result += "PoL " + "Purposeful Communicators: ".toUpperCase() + PC_INPUT.value + "%0D%0A%0D%0A";
  }
  if (SA_INPUT.value != "") {
    result += "PoL " + "Self-Advocates: ".toUpperCase() + SA_INPUT.value + "%0D%0A%0D%0A";
  }
  if (RL_INPUT.value != "") {
    result += "PoL " + "Resilient Learners: ".toUpperCase() + RL_INPUT.value + "%0D%0A%0D%0A";
  }
  
  if (ORS_INPUT.value != "") {
    result += "Opportunities, Resources, and Support: ".toUpperCase() + ORS_INPUT.value + "%0D%0A%0D%0A";
  }
  if (MIN_INPUT.value != "") {
    result += "Meet Individual Needs: ".toUpperCase() + MIN_INPUT.value + "%0D%0A%0D%0A";
  }
  if (TF_INPUT.value != "") {
    result += "Timely Feedback: ".toUpperCase() + TF_INPUT.value + "%0D%0A%0D%0A";
  }
  if (PII_INPUT.value != "") {
    result += "Personalized Instruction and Intervention: ".toUpperCase() + PII_INPUT.value + "%0D%0A%0D%0A";
  }
  if (EO_INPUT.value != "") {
    result += "Engaging Opportunities: ".toUpperCase() + EO_INPUT.value + "%0D%0A%0D%0A";
  }
  if (ECE_INPUT.value != "") {
    result += "Embrace Culture and Experience: ".toUpperCase() + ECE_INPUT.value + "%0D%0A%0D%0A";
  }
